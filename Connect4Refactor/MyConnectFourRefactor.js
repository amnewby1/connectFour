class Game {
  ...
  endGame(msg) {
    ...
    top.removeEventListener("click", this.handleUserClick);
  }
...
document.getElementById("startGame").addEventListener("click", () => {
  let player1 = new Player(document.getElementById("colorPlayer1").value);
  let player2 = new Player(document.getElementById("colorPlayer2").value);
